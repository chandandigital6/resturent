            ...
            <div class="container my-5 py-5">
                ...
                <div class="row align-items-center g-5">
                    <div class="col-lg-6 text-center text-lg-start">
                        <h1 class="display-3 text-white animated slideInLeft">{{$banners->title}}</h1>
                        <p class="text-white animated slideInLeft mb-4 pb-2"> {{$banners->sub_title}}</p>
                        <a href="{{route('contact')}}" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Book A Table</a>
                    </div>
                    <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                        <img class="img-fluid" src="{{asset('storage/'.$banners->image)}}" alt="">
                    </div>
                </div>
                @endforeach
            </div>
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form action="{{route('appointment.store')}}" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" name="msg" style="height: 100px"></textarea>
                                        <label for="message">Special Request</label>
                                    </div>
                                </div>
                                <div class="col-12">
